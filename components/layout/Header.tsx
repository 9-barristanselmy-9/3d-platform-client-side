...
const Header = () => {
  ...
  return (
    <header className="w-full border-b border-slate-100 bg-white/80 backdrop-blur-md px-4 py-6 flex items-center justify-between sticky top-0 z-50">
      {/* Logo */}
      ...
      <div className="flex items-center space-x-6">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-56 mt-2 border-slate-200 shadow-lg"
          >
